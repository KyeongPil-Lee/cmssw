...
if __name__ == '__main__':
    ...
    config.General.requestName = 'SingleMuon_Run2016F_notFinished'
    config.Data.inputDataset = '/SingleMuon/Run2016F-HIPM_UL2016_MiniAODv2-v2/MINIAOD'
    config.Data.lumiMask = './notFinishedLumis_SingleMuon_Run2016F.json'
    crabCommand('submit', config = config)
    ...
    config.General.requestName = 'DoubleMuon_Run2016E_notFinished'
    config.Data.inputDataset = '/DoubleMuon/Run2016E-HIPM_UL2016_MiniAODv2-v1/MINIAOD'
    config.Data.lumiMask = './notFinishedLumis_DoubleMuon_Run2016E.json'
    crabCommand('submit', config = config)
