...
def Get_PSetName(era):
    pSetName = "undefined"
    if era == "16pre"    : pSetName = "DYNanoAOD_2016preAPV_mc_CT18.py"
    elif era == "16post" : pSetName = "DYNanoAOD_2016postAPV_mc_CT18.py"
    elif era == "17"     : pSetName = "DYNanoAOD_2017_mc_CT18.py"
    elif era == "18"     : pSetName = "DYNanoAOD_2018_mc_CT18.py"
