...
# testFile = "/store/data/Run2018D/SingleMuon/MINIAOD/UL2018_MiniAODv2_GT36-v1/610000/19678FA7-BABE-6145-A2D7-40A3E70406FB.root"
testFile = "/store/data/Run2018D/EGamma/MINIAOD/UL2018_MiniAODv2-v2/2810000/3304FBA8-C588-6B45-B276-16AA6448DC6F.root"
nEvent = 1000
process.source.fileNames = cms.untracked.vstring(testFile)
process.maxEvents.input = cms.untracked.int32(nEvent)