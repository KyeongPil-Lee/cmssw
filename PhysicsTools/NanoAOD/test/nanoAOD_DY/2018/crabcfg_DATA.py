...
if __name__ == '__main__':
    ...
    config.Data.inputDataset = '/SingleMuon/Run2018C-UL2018_MiniAODv2_GT36-v2/MINIAOD'
    crabCommand('submit', config = config)

    config.General.requestName = 'SingleMuon_Run2018D'
    config.Data.inputDataset = '/SingleMuon/Run2018D-UL2018_MiniAODv2_GT36-v1/MINIAOD'
    crabCommand('submit', config = config)

    # -- DoubleMuon
    config.General.requestName = 'DoubleMuon_Run2018A'
    config.Data.inputDataset = '/DoubleMuon/Run2018A-UL2018_MiniAODv2_GT36-v1/MINIAOD'
    crabCommand('submit', config = config)

    config.General.requestName = 'DoubleMuon_Run2018B'
    config.Data.inputDataset = '/DoubleMuon/Run2018B-UL2018_MiniAODv2_GT36-v1/MINIAOD'
    crabCommand('submit', config = config)

    config.General.requestName = 'DoubleMuon_Run2018C'
    config.Data.inputDataset = '/DoubleMuon/Run2018C-UL2018_MiniAODv2_GT36-v1/MINIAOD'
    crabCommand('submit', config = config)

    config.General.requestName = 'DoubleMuon_Run2018D'
