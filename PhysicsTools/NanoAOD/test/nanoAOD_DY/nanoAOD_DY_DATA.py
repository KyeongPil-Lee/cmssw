...
# with command line options: --python_filename nanoAOD_DY_DATA.py --eventcontent NANOAOD --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAOD --fileout file:nanoAOD_DY_DATA.root --conditions 106X_dataRun2_v36 --step NANO --era Run2_2016_HIPM,run2_nanoAOD_106Xv2 --no_exec --data -n -1
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:nanoAOD_DY_DATA.root'),
